...
# Run Image
sudo docker run -p 80:80 -p 443:443 --name centos-mro-rstudio-opencpu-shiny-server -v $HOME/Shared/shiny:/home/shiny:rw,z -ti mjmg/centos-mro-rstudio-opencpu-shiny-server /bin/bash
